...
exports.DossierSchema = zod_1.z.object({
    ...
    juridiction_id: zod_1.z.preprocess((value) => (value === undefined || value === null ? undefined : String(value)), zod_1.z.string().optional()),
    prison_id: zod_1.z.preprocess((value) => (value === undefined || value === null ? undefined : String(value)), zod_1.z.string().optional()),
    prison_name: zod_1.z.string().optional(),
    nom: zod_1.z.string(),
    ...
    decision_dapg: zod_1.z.string().optional(),
    date_decision_dapg: zod_1.z.string().optional(),
    duree_temps_epreuve: zod_1.z.preprocess((value) => (value === undefined || value === null ? undefined : String(value)), zod_1.z.string().optional()),
